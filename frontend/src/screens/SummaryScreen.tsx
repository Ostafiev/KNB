...
function OutcomeCue({ outcome, label }: { outcome: Outcome; label: string }) {
  ...
  return (
    <div
      ...
      style={{
        /*
         * Занавес глухой, без единого процента прозрачности.
         *
         * Сначала он был полупрозрачным — и это читалось не как объявление,
         * а как два экрана, наложенные друг на друга: сквозь слово просвечивали
         * табло, кнопки и суммы. «Старт» перед боем работает именно потому,
         * что под ним пусто. Значит и здесь под словом должно быть пусто.
         */
